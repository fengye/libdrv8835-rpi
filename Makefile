...
DRV8835_SERVER_SRC=test_drv8835_socket_server.c
TEST_DRV8835_SOCKET_CLIENT_SRC=test_drv8835_socket_client.c
DRV8835_SDL_CLIENT_SRC=test_sdl_client.c
...
SHARED_LIB_BIN=libdrv8835-shared.so
...
$(DRV8835_SERVER_BIN): $(DRV8835_SERVER_OBJS) $(LIB_BIN)
	$(CC) $(LIBFLAGS) $(DRV8835_SERVER_OBJS) $(LDFLAGS) -ldrv8835 -o $@
...
$(DRV8835_SDL_CLIENT_BIN): $(DRV8835_SDL_CLIENT_OBJS) $(LIB_BIN)
	$(CC) $(LIBFLAGS) $(DRV8835_SDL_CLIENT_OBJS) $(LDFLAGS) $(SDL_LDFLAGS) -ldrv8835 -o $@
.c.o:
