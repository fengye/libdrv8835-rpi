...
SOURCES=$(DAEMON_SOURCES) $(LIB_SOURCES) $(TEST_THREAD_SRC) $(TEST_SOCKET_SRV_SRC) $(TEST_SOCKET_CLT_SRC) $(TEST_DRV8835_MOTOR_SERVER_SRC) $(TEST_DRV8835_SOCKET_SERVER_SRC) 
INCPATHS=./ 
LIBPATHS=./
...
OBJECTS=$(DAEMON_OBJECTS) $(LIB_OBJECTS) $(TEST_THREAD_OBJS) $(TEST_SOCKET_SRV_OBJS) $(TEST_SOCKET_CLT_OBJS) $(TEST_DRV8835_MOTOR_SERVER_OBJS) $(TEST_DRV8835_SOCKET_SERVER_OBJS)
...
BINARY=$(DAEMON_BINARY) $(LIB_BIN) $(TEST_THREAD_BINARY) $(TEST_SOCKET_SRV_BIN) $(TEST_SOCKET_CLT_BIN) $(TEST_DRV8835_MOTOR_SERVER_BIN) $(TEST_DRV8835_SOCKET_SERVER_BIN)
all: $(SOURCES) $(BINARY)
...
$(TEST_DRV8835_MOTOR_SERVER_BIN): $(TEST_DRV8835_MOTOR_SERVER_OBJS)
